...
-- Library functions 
    -- Misc functions
        ...
        function Library:UpdateConfigList() 
            ...
            for _,file in listfiles(Library.Directory .. "/Library/Configs") do
                local Name = file:gsub(Library.Directory .. "/Library/Configs\\", ""):gsub(".cfg", ""):gsub(Library.Directory .. "\\Library\\Configs\\", "")
                List[#List + 1] = Name
            end
    ...
    -- Library element functions
        function Library:Window(properties)
            local Cfg = {
                Name = properties.Name or "LunarWare.gg";
            ...
            local Items = Cfg.Items; do
                ...
                -- Watermark
                    ...
                    task.spawn(function()
                        while Library.Items and Library.Items.Parent do
                            local europeTime = os.date("*t", os.time() + 2 * 3600)
                            local timeStr = string.format("%02d:%02d:%02d", europeTime.hour, europeTime.min, europeTime.sec)
                            Items.WatermarkTitle.Text = string.format(
                                "%s | Time : %s | Version : Paid",
                                Cfg.Name,
                                timeStr
                            )
                            task.wait(1)
        ...
        function Library:Configs(window) 
            ...
            Section:Button({Name = "Save", Callback = function() 
                writefile(Library.Directory .. "/Library/Configs/" .. ConfigText .. ".cfg", Library:GetConfig())
                Library:UpdateConfigList()
                Notifications:Create({Name = "Saved Config (" ..  Library.Directory .. "/Library/Configs/" .. ConfigText .. ".cfg" .. ")"}) 
            end})

            Section:Button({Name = "Load", Callback = function() 
                Library:LoadConfig(readfile(Library.Directory .. "/Library/Configs/" .. ConfigText .. ".cfg"))  
                Library:UpdateConfigList() 
                Notifications:Create({Name = "Loaded Config (" ..  Library.Directory .. "/Library/Configs/" .. ConfigText .. ".cfg" .. ")"}) 
            end})

            Section:Button({Name = "Delete", Callback = function() 
                delfile(Library.Directory .. "/Library/Configs/" .. ConfigText .. ".cfg")  
                Library:UpdateConfigList() 
                Notifications:Create({Name = "Deleted Config (" ..  Library.Directory .. "/Library/Configs/" .. ConfigText .. ".cfg" .. ")"}) 
            end})
